                ...
                <div class="tab-pane fade active show" id="menu-starters">
                    ...
                    <div class="row gy-5">
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('frontend') }}/assets/img/menu/menu-item-1.png" class="glightbox"><img
                                    src="{{ asset('frontend') }}/assets/img/menu/menu-item-1.png"
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('frontend') }}/assets/img/menu/menu-item-2.png" class="glightbox"><img
                                    src="{{ asset('frontend') }}/assets/img/menu/menu-item-2.png"
                                    class="menu-img img-fluid" alt=""></a>
                            <h4>Aut Luia</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('frontend') }}/assets/img/menu/menu-item-3.png" class="glightbox"><img
                                    src="{{ asset('frontend') }}/assets/img/menu/menu-item-3.png"
                                    class="menu-img img-fluid" alt=""></a>
                            <h4>Est Eligendi</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('frontend') }}/assets/img/menu/menu-item-4.png" class="glightbox"><img
                                    src="{{ asset('frontend') }}/assets/img/menu/menu-item-4.png"
                                    class="menu-img img-fluid" alt=""></a>
                            <h4>Eos Luibusdam</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('frontend') }}/assets/img/menu/menu-item-5.png" class="glightbox"><img
                                    src="{{ asset('frontend') }}/assets/img/menu/menu-item-5.png"
                                    class="menu-img img-fluid" alt=""></a>
                            <h4>Eos Luibusdam</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{ asset('frontend') }}/assets/img/menu/menu-item-6.png" class="glightbox"><img
                                    src="{{ asset('frontend') }}/assets/img/menu/menu-item-6.png"
                                    class="menu-img img-fluid" alt=""></a>
              ...
              "1200": {
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                        style="background-image: url({{ asset('frontend') }}/assets/img/events-1.jpg)">
                    ...
                    <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                        style="background-image: url({{ asset('frontend') }}/assets/img/events-2.jpg)">
                    ...
                    <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                        style="background-image: url({{ asset('frontend') }}/assets/img/events-3.jpg)">
                    ...
                    <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                        style="background-image: url({{ asset('frontend') }}/assets/img/events-4.jpg)">
